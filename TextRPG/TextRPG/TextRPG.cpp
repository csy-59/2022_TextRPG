...
*					   죽겠어요				(넋을 잃고 스트레스를 5 줄인다.)								(2)
*					   프로그래밍이란 무엇인가..(체력을 5증가한다.)											(5)
* 
*			> lev. 20: 삼중나선문			(기본 공격력 * 3.5 의 공격을 한다. 스트레스가 3 오른다.)		(3/3)
*					   잘잤어, 실베스터?	(스트레스가 10 줄어든다.)										(1/1)
*					   (10 때 선택하지 않은 스킬 중 하나)
*		> 레벨 증가에 필요한 양
*			> lev 1 ~ 10 : 10 + 다음 레벨 * 2
*			> lev 11 ~ 20 : 20 + 다음 레벨 * 2
...
*			> 한솥: 체력을 1.2배로 회복한다. 스트레스를 2 줄인다. (5G)
*			> NBB: 체력을 1.5배로 회복한다. 스트레스를 5 줄인다. (10G)
*		
*		> 숲: 전투를 진행한다. (후설)
*			> 전투를 3회 진행하면 회복의 연못에 도착한다. (무조건)
*				> 회복의 연못에 도착하면 스트레스가 2 줄어들고 체력을 1.5배로 회복한다.
* 
* >> 스테이지마다 다른 적이 나타나며, 적이 나타나면 배틀이 시작된다.
*	> Stage 1
*		> 공부몬: (플레이어 체력 * 0.4~0.5) (0.3 ~ 0.5 * 플레이어 기본 공격력, 최소 1) 사이의 공격. 10% 확률로 1G 드랍 
*			> 교수님의 기습 질문!
*			> 공격: 객체 지향적 프로그래밍은 뭐죠?
* 
*		> 졸음몬: (0.2 ~ 0.4 * 플레이어 기본 공격력, 최소 1) 사이의 공격. 방어력 1. 10% 확률로 1G 드랍
*			> 포근한 침대 생각~
*			> 공격: 눕고 싶다...
* 
*	> Stage 2
...
*			> 공격: 이게 머지 히히
* 
*		> 피곤몬: (0.3 ~ 0.6 * 플레이어 기본 공격력, 최소 10) 사이의 공격. 플레이어 방어력의 반의 방어력. 8% 확률로 2G 드랍
*			> 식...곤...증....Zz...
*			> 공격: Zzz...
* 
*	> Stage 2
*		> 과제몬: (0.5 ~ 0.8 * 플레이어 기본 공격력, 최소 20) 사이의 공격. 10% 확률로 1G 드랍 
*			> 분명 어디서 봤는데....
*			> 공격: 포기하면 편한데 히히
* 
*		> 스터디몬: (0.6 ~ 0.7 * 플레이어 기본 공격력, 최소 20) 사이의 공격. 플레이어와 동일한 방어력. 10% 확률로 1G 드랍
*			> 플립플롭? 그게 뭐죠?
*			> 공격: 히히 플립플롭 히히 샘플링
* 
