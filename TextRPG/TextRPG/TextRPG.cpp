...
*			> 공격: ??: 라이브쉐어 들어오세요
* 
*		> 과제몬: (0.3 ~ 0.6 * 플레이어 기본 공격력, 최소 10) 사이의 공격. 플레이어 방어력의 반의 방어력. 8% 확률로 2G 드랍
*			> 식...곤...증....Zz...
*			> 공격: Zzz...
* 
*	> Stage 3
*		> 테크톡몬: (0.5 ~ 0.8 * 플레이어 기본 공격력, 최소 20) 사이의 공격. 10% 확률로 1G 드랍 
*			> 분명 어디서 봤는데....
*			> 공격: 포기하면 편한데 히히
* 
*		> 최선몬: (0.6 ~ 0.7 * 플레이어 기본 공격력, 최소 20) 사이의 공격. 플레이어와 동일한 방어력. 10% 확률로 1G 드랍
*			> 테크톡 매일매일 하는 걸로 바꾸겠습니다.
*			> 공격: 룰렛 돌리겠습니다.
* 
